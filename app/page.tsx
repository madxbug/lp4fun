        ...
        <>
            ...
            <footer className="fixed bottom-0 left-0 right-0 p-4">
                <div className="container mx-auto flex justify-center items-center space-x-4">
                    ...
                    <Link href="/leaderboard" aria-label="Wallet leaderboard"
                          className="text-base-content opacity-0 hover:opacity-100 focus-visible:opacity-100 transition-opacity duration-300">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
